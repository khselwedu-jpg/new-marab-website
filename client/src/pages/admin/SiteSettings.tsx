...
const settingsConfig: SettingField[] = [
  ...
  // Shareholders Page
  { key: "shareholders_capital_title_ar", labelAr: "عنوان بطاقة رأس المال (عربي)", labelEn: "Capital Card Title (Arabic)", category: "shareholders" },
  { key: "shareholders_capital_title_en", labelAr: "عنوان بطاقة رأس المال (إنجليزي)", labelEn: "Capital Card Title (English)", category: "shareholders" },
  { key: "shareholders_capital_amount_ar", labelAr: "قيمة رأس المال (عربي)", labelEn: "Capital Amount (Arabic)", category: "shareholders" },
  { key: "shareholders_capital_amount_en", labelAr: "قيمة رأس المال (إنجليزي)", labelEn: "Capital Amount (English)", category: "shareholders" },
  { key: "shareholders_capital_desc_ar", labelAr: "وصف بطاقة رأس المال (عربي)", labelEn: "Capital Card Description (Arabic)", category: "shareholders" },
  { key: "shareholders_capital_desc_en", labelAr: "وصف بطاقة رأس المال (إنجليزي)", labelEn: "Capital Card Description (English)", category: "shareholders" },
  { key: "shareholders_page_title_ar", labelAr: "عنوان الصفحة (عربي)", labelEn: "Page Title (Arabic)", category: "shareholders" },
  { key: "shareholders_page_title_en", labelAr: "عنوان الصفحة (إنجليزي)", labelEn: "Page Title (English)", category: "shareholders" },
  { key: "shareholders_page_subtitle_ar", labelAr: "وصف الصفحة (عربي)", labelEn: "Page Subtitle (Arabic)", category: "shareholders", multiline: true },
  { key: "shareholders_page_subtitle_en", labelAr: "وصف الصفحة (إنجليزي)", labelEn: "Page Subtitle (English)", category: "shareholders", multiline: true },
  // About Us Page
  { key: "about_intro_ar", labelAr: "نص التعريف (عربي)", labelEn: "Intro Text (Arabic)", category: "about", multiline: true },
  { key: "about_intro_en", labelAr: "نص التعريف (إنجليزي)", labelEn: "Intro Text (English)", category: "about", multiline: true },
  { key: "about_history_ar", labelAr: "تاريخنا (عربي)", labelEn: "Our History (Arabic)", category: "about", multiline: true },
  { key: "about_history_en", labelAr: "تاريخنا (إنجليزي)", labelEn: "Our History (English)", category: "about", multiline: true },
  { key: "about_values_ar", labelAr: "قيمنا (عربي)", labelEn: "Our Values (Arabic)", category: "about", multiline: true },
  { key: "about_values_en", labelAr: "قيمنا (إنجليزي)", labelEn: "Our Values (English)", category: "about", multiline: true },
  { key: "about_commitment_ar", labelAr: "التزامنا (عربي)", labelEn: "Our Commitment (Arabic)", category: "about", multiline: true },
  { key: "about_commitment_en", labelAr: "التزامنا (إنجليزي)", labelEn: "Our Commitment (English)", category: "about", multiline: true },
  { key: "about_stat1_value", labelAr: "إحصائية 1 - الرقم (15+)", labelEn: "Stat 1 - Value (15+)", category: "about" },
  { key: "about_stat1_label_ar", labelAr: "إحصائية 1 - الوصف (عربي)", labelEn: "Stat 1 - Label (Arabic)", category: "about" },
  { key: "about_stat1_label_en", labelAr: "إحصائية 1 - الوصف (إنجليزي)", labelEn: "Stat 1 - Label (English)", category: "about" },
  { key: "about_stat2_value", labelAr: "إحصائية 2 - الرقم (25,000+)", labelEn: "Stat 2 - Value (25,000+)", category: "about" },
  { key: "about_stat2_label_ar", labelAr: "إحصائية 2 - الوصف (عربي)", labelEn: "Stat 2 - Label (Arabic)", category: "about" },
  { key: "about_stat2_label_en", labelAr: "إحصائية 2 - الوصف (إنجليزي)", labelEn: "Stat 2 - Label (English)", category: "about" },
  { key: "about_stat3_value", labelAr: "إحصائية 3 - الرقم (60+)", labelEn: "Stat 3 - Value (60+)", category: "about" },
  { key: "about_stat3_label_ar", labelAr: "إحصائية 3 - الوصف (عربي)", labelEn: "Stat 3 - Label (Arabic)", category: "about" },
  { key: "about_stat3_label_en", labelAr: "إحصائية 3 - الوصف (إنجليزي)", labelEn: "Stat 3 - Label (English)", category: "about" },
  // Footer
...
const categoryLabels: Record<string, string> = {
  ...
  shareholders: "صفحة المساهمون والشركاء",
  about: "صفحة من نحن",
