  ...
  const branches = [
    {
      ...
      addressEn: "Al-Zubairi Street, Sana'a",
      phone: "+967 1 234 567",
    ...
    },
    {
      ...
      addressEn: "Al-Mualla Street, Aden",
      phone: "+967 2 345 678",
            ...
            >
              ...
              <div className="p-6 space-y-4">
                <h3 className="text-xl font-bold text-primary">
                  {t("nav.home") === "الرئيسية" ? branch.name : branch.nameEn}
                </h3>
                <div className="flex items-start gap-2 text-foreground/70">
                  <MapPin className="w-5 h-5 text-secondary flex-shrink-0 mt-0.5" />
                  <p className="text-sm">
                    {t("nav.home") === "الرئيسية" ? branch.address : branch.addressEn}
                  </p>
                </div>
